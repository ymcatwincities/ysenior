...
/* profiles/contrib/openy/themes/openy_themes/openy_carnation/templates/paragraph/paragraph--small-banner.html.twig */
class __TwigTemplate_fce6c21777df5b9b54241f7bdefb47f5a24287d9f4d23b8959f3d09b2469e7d8 extends \Twig\Template
{
...
($context["view_mode"] ?? null)) ? (("paragraph--view-mode--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null))))) : ("")), 3 => "banner", 4 => "banner--small"];
        // line 48
...
<div";
  ...
  ";
        ...
        if ( !$this->getAttribute($this->getAttribute(($context["paragraph"] ?? null), "field_prgf_image", []), "isEmpty", [], "method")) {
            ...
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, call_user_func_array($this->env->getFunction('file_url')->getCallable(), [$this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["paragraph"] ?? null), "field_prgf_image", []), "entity", []), "field_media_image", []), "entity", []), "uri", []), "value", []))]), "html", null, true);
...
";
    ...
    {
        return "profiles/contrib/openy/themes/openy_themes/openy_carnation/templates/paragraph/paragraph--small-banner.html.twig";
    }
    ...
    {
        return array (  107 => 68,  102 => 66,  97 => 64,  94 => 63,  92 => 62,  85 => 57,  77 => 53,  75 => 52,  64 => 50,  61 => 49,  59 => 48,  57 => 43,  56 => 42,  55 => 40,);
    }
    ...
    {
        return new Source("", "profiles/contrib/openy/themes/openy_themes/openy_carnation/templates/paragraph/paragraph--small-banner.html.twig", "/var/www/docroot/profiles/contrib/openy/themes/openy_themes/openy_carnation/templates/paragraph/paragraph--small-banner.html.twig");
    }
}
